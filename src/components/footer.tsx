      ...
      <div className="container grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li>
              <a href="mailto:contact@agentforcehr.com" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                Contact
              </a>
            </li>
          </ul>
      ...
      <div className="container mt-8 pt-8 border-t">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="https://twitter.com/agentforcehr" className="text-muted-foreground hover:text-foreground">
              <svg
            ...
            <a href="#" className="text-muted-foreground hover:text-foreground opacity-50 cursor-not-allowed">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <a href="https://github.com/agentforcehr" className="text-muted-foreground hover:text-foreground">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
