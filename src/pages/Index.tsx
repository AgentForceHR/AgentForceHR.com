      ...
      <main className="flex flex-col items-center">
        ...
        <section className="w-full py-20 px-4 bg-background border-t">
          <div className="container mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Experience our complete platform with full demo access including agent creation and HR token management
            </p>
            <Button variant="hero" size="xl" asChild className="group">
              <Link to="/investor-demo">
                <Eye className="w-5 h-5 mr-2" />
                Access Investor Demo
                <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
              </Link>
            </Button>
            <p className="text-sm text-muted-foreground mt-4">
              Create agents, manage HR tokens, and explore all features in a simulated environment
            </p>
          </div>
        </section>
      </main>
